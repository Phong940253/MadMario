...
def visualize_game(
    ...
    details_surface_1 = normal_font.render(details_hub_text_1, True, (255, 255, 255))
    details_surface_2 = normal_font.render(details_hub_text_2, True, (255, 255, 255))
    details_surface_3 = normal_font.render(details_hub_text_3, True, (255, 255, 255))
    details_surface_4 = normal_font.render(details_hub_text_4, True, (255, 255, 255))
